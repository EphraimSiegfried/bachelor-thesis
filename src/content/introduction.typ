...
This project is motivated by the hypothesis that core features of the Nix package manager can be implemented using Git's internal object model. This concept is explored through the development of Gachix, a binary cache for Nix and the primary subject of this thesis. #footnote[https://github.com/EphraimSiegfried/gachix]
